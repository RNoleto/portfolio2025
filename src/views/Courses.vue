...
const courses = [
  ...
  },
  {
    ...
    descricao:"Criando o projeto In.Orbit do ZERO usando JavaScript e conceitos aprendidos durante a aula",
    producao:"Rocketseat",
    imagem:"/img/stacks/js.svg",
    corFundoCode:"bg-[#9C8F5D]",
    corFundo:"bg-[#F5F5D0]",
  ...
  },
  {
    ...
    mesAno:"Novembro - 2024",
    descricao:"Desenvolvimento de SaaS de gerenciamento financeiro com insights gerados por IA.",
